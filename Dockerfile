...
# Recompilation entrypoint
ENTRYPOINT [ "/bin/bash", "-c", "cd /app/paraview-build && rm superbuild/paraview/stamp/paraview-build && make && ./install/bin/paraview" ]


# cmake ../paraview-superbuild -DENABLE_xdmf3=1 -DENABLE_qt5=1 -DENABLE_mpi=1 -DENABLE_hdf5=1 -DUSE_SYSTEM_qt5=1 -DUSE_SYSTEM_mpi=1 -DCMAKE_BUILD_TYPE=Release